      ...
      <div>
        ...
        <div className='relative z-10 border border-[#D434FE] mt-16 py-7 px-9 rounded-md w-[85%] mx-auto grid grid-cols-3 grid-rows-2 gap-3 '>
              ...
              <div className='relative z-10 w-[100%] h-[45px] flex justify-center items-center'>
                ...
                <Image src={logo1} alt='logo' width={1000} className='w-[90%] h-[40px] object-contain bg-center bg-no-repeat mx-auto'></Image>
              </div>
              <div className='relative w-[100%] h-[45px] flex justify-center items-center'>
                <div className='h-full w-[2px] bg-[#D434FE] absolute right-0'></div>
                <div className='h-[2px] w-[90%] bg-[#D434FE] absolute bottom-[-0.2rem] right-2'></div>
              ...
              <div className='relative w-[100%] h-[45px]'>
                <div className='h-[2px] w-[90%] bg-[#D434FE] absolute bottom-[-0.2rem] right-2'></div>
                <Image src={logo3} alt='logo' width={1000} className='w-[90%] h-[40px] object-contain bg-center bg-no-repeat mx-auto mr-4'></Image>
              </div>

              <div className='relative w-[100%] h-[45px]'>
              <div className='h-full w-[2px] bg-[#D434FE] absolute right-0'></div>
              <Image src={logo4} alt='logo' width={1000} className='w-[90%] h-[40px] object-contain bg-center bg-no-repeat mx-auto mr-4'></Image>
              </div>
              <div className='relative w-[100%] h-[45px]'>
              <div className='h-full w-[2px] bg-[#D434FE] absolute right-0'></div>
              <Image src={logo5} alt='logo' width={1000} className='w-[90%] h-[40px] object-contain bg-center bg-no-repeat mx-auto mr-4'></Image>
              </div>
              <div className='relative w-[100%] h-[45px]'>
              <Image src={logo6} alt='logo' width={1000} className='relative z-10 w-[100%] h-[40px] object-contain bg-center bg-no-repeat mx-auto mr-4'></Image>
              </div>
        </div>
      </div>
