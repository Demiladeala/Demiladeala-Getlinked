                ...
                <div className=''>
                    ...
                    <h1 style={{ mixBlendMode: 'normal' }} className='relative z-10 text-center mt-[4rem]'>
                        <div className='relative font-bold text-[32px] max-[280px]:text-2xl'>
                            ...
                            <Image src={star1} alt='star' className='absolute top-[-1.3rem] max-[280px]:top-[-1.4rem] left-[30%] object-cover bg-no-repeat bg-center'></Image>
                            </div>
                        ...
                        <div className='flex items-center justify-center font-bold text-[32px] max-[280px]:text-2xl'>
                            ...
                            <Image src={chain} alt='arrow' className='object-cover bg-no-repeat bg-center'></Image>
                            <Image src={spark} alt='arrow' className='object-cover bg-no-repeat bg-center'></Image>
                        </div>
                    </h1>
